...
The first numbers in bracket are average salary, the second numbers in brackets are density of cultural institution per region in Italy.
...
The first numbers in bracket are average salary, the second numbers in brackets are internet diffusion per region in Italy.
...
The first numbers in bracket are average salary, the second numbers in brackets are theater density per region in Italy.
...
The first numbers in bracket are internet diffusion, the second numbers in brackets are density of cultural institution per region in Italy.
...
The first numbers in bracket are internet diffusion, the second numbers in brackets are crime rate per region in Italy.
...
The first numbers in bracket are internet diffusion, the second numbers in brackets are theater density per region in Italy.
...
The first numbers in bracket are crime rate, the second numbers in brackets are theater density per region in Italy.
...
The first numbers in bracket are crime rate, the second numbers in brackets are density of cultural institution per region in Italy.
...
Correlation between density of cultural institution and theater density:

The first numbers in bracket are density of cultural institution, the second numbers in brackets are theater density per region in Italy.
...
As it is seen the avarage salary doesnt affect density of cultural institution, crime rate and theater density while the internet diffusion increases with the increase of avarage salary per region. There is positive correlation between internet diffusion and cultural institution density but there is negative correlation between internet diffusion and crime rate. Additionally, there is low negative correlation between internet diffusion and theater density. We can deduce that the crime rate increases the theater density more than cultural institution. 
